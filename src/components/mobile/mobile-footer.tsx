...
export function MobileFooter() {
  ...
  return (
    <footer className={`relative w-full z-40 bg-transparent ${isAboutPage ? "mt-[-40px]" : "mt-0"}`}>
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="flex justify-between items-end gap-4 border-b border-black/[0.03] pb-6">
            <div className="flex-1 space-y-2">
              ...
              <div className="relative group max-w-[160px]">
                <input
                  type="email"
                  placeholder="EMAIL"
                  className={`w-full bg-transparent border-b py-1 text-[9px] font-bold tracking-[0.1em] outline-none transition-all ${isAboutPage ? "border-white/10 focus:border-white" : "border-black/5 focus:border-black"
                    }`}
                />
            ...
            <div className="space-y-2 flex flex-col items-end">
              <h2 className="text-[7px] font-bold uppercase tracking-[0.3em] opacity-40 uppercase">Customer Support</h2>
          ...
          <div className="pt-6 border-t border-black/[0.03] flex flex-col items-center justify-center gap-4">
            <a href="https://www.zyvextech.co/" target="_blank" rel="noopener noreferrer" className="font-serif italic text-[10px] text-black/70 hover:text-black transition-colors underline underline-offset-[5px] decoration-[0.5px] decoration-black/30 hover:decoration-black text-center">
              Developed by Zyvex Tech LLP
            </a>
            <p className="text-[8.5px] font-bold uppercase tracking-[0.3em] opacity-30 text-center">© 2024 COLIN GUEST.</p>
          </div>
        </div>
      </div>
    </footer>
