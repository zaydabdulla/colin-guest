      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-[72px] h-[calc(100vh-72px)] w-full sm:w-[450px] bg-white/60 backdrop-blur-3xl z-[101] shadow-2xl flex flex-col border-l border-black/5"
          >
            {/* Header */}
