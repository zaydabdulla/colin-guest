        ...
        {isLightboxOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-transparent rounded-2xl overflow-hidden max-w-sm sm:max-w-md w-full shadow-2xl relative flex flex-col max-h-[85vh] p-2"
            >
              <button
                onClick={() => setIsLightboxOpen(false)}
              ...
              <div className="relative w-full aspect-[4/5] bg-neutral-900 rounded-2xl overflow-hidden">
                <Image
