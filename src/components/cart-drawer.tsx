...
export function CartDrawer() {
  ...
  const { items, isOpen, closeCart, removeFromCart, updateQuantity, addToCart, user } = useCartStore();
  ...
  const primaryAddress = (user?.addresses || []).find((a: any) => Boolean(a && a.id && a.address1)) || null;
